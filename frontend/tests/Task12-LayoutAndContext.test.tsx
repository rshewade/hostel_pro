...
describe('Task 12.3 - Superintendent Dashboard: Layout and Vertical Context', () => {
  ...
  describe('Overall Layout', () => {
    it('has proper header with title and vertical badge', () => {
  ...
  describe('Vertical Filter Chips', () => {
    it('has color-coded vertical filter chips', () => {
      render(<SuperintendentDashboard />);
    ...
    it('All Verticals chip has navy styling by default', () => {
      render(<SuperintendentDashboard />);

      // Find the button element (not header badge)
      const allVerticalsElements = screen.getAllByText('All Verticals');
    ...
    it('vertical filter chips are buttons with rounded-full class', () => {
      render(<SuperintendentDashboard />);
  ...
  describe('Status Filter Chips', () => {
    it('has color-coded status filter chips', () => {
      render(<SuperintendentDashboard />);
    ...
    it('All Statuses chip has navy styling by default', () => {
      render(<SuperintendentDashboard />);
  ...
  describe('Vertical Context Indicators', () => {
    it('shows vertical badge in header', () => {
      render(<SuperintendentDashboard />);

      // Find the header badge (span, not the button filter chip)
      const allVerticalsElements = screen.getAllByText('All Verticals');
    ...
    it('vertical badges in table use color coding', () => {
      render(<SuperintendentDashboard />);
  ...
  describe('Visual Safeguards Against Cross-Vertical Errors', () => {
    it('vertical color coding is consistent across interface', () => {
      render(<SuperintendentDashboard />);
    ...
    it('status color coding is consistent across interface', () => {
      render(<SuperintendentDashboard />);
  ...
  describe('Tab Navigation', () => {
    it('active tab has navy border indicator', () => {
      render(<SuperintendentDashboard />);
  ...
  describe('Responsive Design', () => {
    it('filter layout supports flex-wrap', () => {
      render(<SuperintendentDashboard />);

...
import { FormWizard, Input, Select, DatePicker } from '@/components/forms';
              ...
              >
                ...
                <label htmlFor="photo-upload" className="cursor-pointer">
                  ...
                  <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
                    JPG, JPEG or PDF (Max 5MB)
                  </p>
                </label>
              </div>
              {data.photoFile && (
                <div className="mt-4 flex items-center justify-between p-4 rounded-lg" style={{ backgroundColor: 'var(--color-green-50)' }}>
                  <span className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>
                    {data.photoFile.name}
                  </span>
                  <Button variant="ghost" size="sm" onClick={() => onChange('photoFile', null)}>
                    Remove
                  </Button>
                </div>
              )}
              {errors.photoFile && (
                <p className="text-sm mt-2" style={{ color: 'var(--color-red-600)' }}>{errors.photoFile}</p>
              )}
            </div>
            ...
            <div className="card p-6 border-2" style={{ borderColor: 'var(--border-primary)' }}>
              ...
              >
                <input
                  type="file"
                  accept=".jpg,.jpeg,.pdf"
                  onChange={(e) => onChange('birthCertificate', e.target.files?.[0])}
                  className="hidden"
              ...
              {data.birthCertificate && (
                <div className="mt-4 flex items-center justify-between p-4 rounded-lg" style={{ backgroundColor: 'var(--color-green-50)' }}>
                  <span className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>
                    {data.birthCertificate.name}
                  </span>
                  <Button variant="ghost" size="sm" onClick={() => onChange('birthCertificate', null)}>
                    Remove
                  </Button>
                </div>
              )}
              {errors.birthCertificate && (
                <p className="text-sm mt-2" style={{ color: 'var(--color-red-600)' }}>{errors.birthCertificate}</p>
              )}
            </div>
            ...
            <div className="card p-6 border-2" style={{ borderColor: 'var(--border-primary)' }}>
              ...
              >
                <input
                  type="file"
                  accept=".jpg,.jpeg,.pdf"
                  onChange={(e) => onChange('marksheet', e.target.files?.[0])}
                  className="hidden"
                  id="marksheet-upload"
                />
              ...
              {data.marksheet && (
                <div className="mt-4 flex items-center justify-between p-4 rounded-lg" style={{ backgroundColor: 'var(--color-green-50)' }}>
                  ...
                  <Button variant="ghost" size="sm" onClick={() => onChange('marksheet', null)}>
                    Remove
                  </Button>
                </div>
              )}
              {errors.marksheet && (
                <p className="text-sm mt-2" style={{ color: 'var(--color-red-600)' }}>{errors.marksheet}</p>
              )}
            </div>

            <div className="card p-6 border-2" style={{ borderColor: 'var(--border-primary)' }}>
              <h3 className="text-lg font-semibold mb-4" style={{ color: 'var(--text-primary)' }}>
                Community Recommendation Letter (Optional)
              </h3>
              <div
                className="border-2 border-dashed rounded-lg p-8 text-center cursor-pointer hover:border-blue-500 transition-colors"
                style={{ borderColor: 'var(--border-primary)' }}
              >
                <input
                  type="file"
                  accept=".jpg,.jpeg,.pdf"
                  onChange={(e) => onChange('recommendationLetter', e.target.files?.[0])}
                  className="hidden"
              ...
              {data.recommendationLetter && (
                <div className="mt-4 flex items-center justify-between p-4 rounded-lg" style={{ backgroundColor: 'var(--color-green-50)' }}>
                  ...
                  <Button variant="ghost" size="sm" onClick={() => onChange('recommendationLetter', null)}>
                    Remove
                  </Button>
                </div>
              )}

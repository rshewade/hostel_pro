      ...
      <main className="px-6 py-12">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="text-lg mb-8" style={{ color: 'var(--text-secondary)' }}>
            {t('Your application for Boys Hostel has been received. We will review your application and contact you soon.', 'बालक छात्रावास के लिए आपका आवेदन प्राप्त हो गया है। हम आपके आवेदन की समीक्षा करेंगे और जल्द ही संपर्क करेंगे।')}</p>

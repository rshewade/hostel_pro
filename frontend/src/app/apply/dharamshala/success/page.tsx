      ...
      <main className="px-6 py-12">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="text-lg mb-8" style={{ color: 'var(--text-secondary)' }}>
            {t('Your application for Dharamshala has been received. We will review your application and contact you soon.', 'धरमशाला के लिए आपका आवेदन प्राप्त हो गया है। हम आपके आवेदन की समीक्षा करेंगे और जल्द ही संपर्क करेंगे।')}</p>
            ...
            <ol className="text-left space-y-3 max-w-md mx-auto">
              <li className="flex items-start gap-3">
                ...
                <span style={{ color: 'var(--text-secondary)' }}>
                  {t('Our team will review your application within 1-2 business days.', 'हमारी टीम 1-2 कार्य दिवसों में आपके आवेदन की समीक्षा करेगी।')}</span>
              </li>
              <li className="flex items-start gap-3">
                <span
                  className="w-6 h-6 rounded-full flex items-center justify-center text-sm font-medium flex-shrink-0"
                ...
                <span style={{ color: 'var(--text-secondary)' }}>
                  {t('You will receive an SMS/email notification about your booking confirmation.', 'आपको बुकिंग पुष्टि के बारे में एसएमएस/ईमेल सूचना प्राप्त होगी।')}</span>
              </li>
              <li className="flex items-start gap-3">
                <span
                  className="w-6 h-6 rounded-full flex items-center justify-center text-sm font-medium flex-shrink-0"
                ...
                <span style={{ color: 'var(--text-secondary)' }}>
                  {t('Upon approval, you will receive check-in instructions and payment details.', 'स्वीकृति के बाद, आपको चेक-इन निर्देश और भुगतान विवरण प्राप्त होंगे।')}</span>
              </li>
            </ol>
          </div>

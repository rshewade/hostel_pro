...
export default function ApplicationFormPage() {
  ...
  const wizardSteps = [
      ...
      component: ({ data, onChange, errors, saving }: any) => (
        <div className="space-y-6">
          ...
          <p className="text-xs italic" style={{ color: 'var(--text-secondary)' }}>
            {t('Note: Medical Fitness Certificate (from MBBS Doctor) is not required at this stage. You will be asked to upload it from your student dashboard after admission is approved.', 'नोट: चिकित्सा फिटनेस प्रमाण पत्र (MBBS डॉक्टर से) इस चरण में आवश्यक नहीं है। प्रवेश स्वीकृत होने के बाद आपको इसे अपने छात्रा डैशबोर्ड से अपलोड करने के लिए कहा जाएगा।')}
          </p>
        </div>
      ),
      validate: (data: any) => {
    ...
    },
    {
      ...
      component: ({ data, onChange, errors }: any) => (
        <TermsAndConditions data={data} onChange={onChange} errors={errors} vertical="girls-ashram" />
      ),
        ...
        <div className="space-y-6">
          ...
          <div className="card p-6 border-2" style={{ backgroundColor: 'var(--color-green-50)', borderColor: 'var(--color-green-200)' }}>
            ...
            <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
              {t('You have accepted all Rules, Instructions and Conditions in the previous step. By submitting, you confirm that all information provided is true and correct to the best of your knowledge.', 'आपने पिछले चरण में सभी नियम, निर्देश और शर्तें स्वीकार कर ली हैं। जमा करके, आप पुष्टि करती हैं कि प्रदान की गई सभी जानकारी आपकी सर्वोत्तम जानकारी के अनुसार सत्य और सही है।')}
            </p>
          </div>
        </div>
      ),
  ...
  return (
    <AdmissionsGate vertical="girls-ashram">

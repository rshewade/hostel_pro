...
export default function InstitutionPage({ params }: { params: Promise<{ id: string }> }) {
      ...
      <PublicLayout>
        <div className="flex items-center justify-center py-32">
          <div className="text-center">
            ...
            <Link href="/" className="underline text-primary">Return to Home</Link>
          </div>
        </div>
      </PublicLayout>
    );
  ...
  const colorClasses = colorMap[institution.color as keyof typeof colorMap] ?? colorMap.blue;

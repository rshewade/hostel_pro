...
const AlumniLogin = () => {
  ...
  const handleSendOtp = async () => {
    if (!email) {
      toast({
        ...
        description: t('Please enter your registered email address.', 'कृपया अपना पंजीकृत ईमेल पता दर्ज करें।'),
        variant: 'destructive',
      });
      return;
    }
    ...
    toast({
      ...
      description: t('A 6-digit code has been sent to your email. Use 123456 for demo.', '6-अंकीय कोड आपके ईमेल पर भेजा गया है। डेमो के लिए 123456 का उपयोग करें।'),
    });
  };
  ...
  const handleVerifyOtp = async () => {
    if (!otp) {
      toast({
        title: t('OTP Required', 'OTP आवश्यक है'),
        description: t('Please enter the OTP sent to your email.', 'कृपया अपने ईमेल पर भेजा गया OTP दर्ज करें।'),
        variant: 'destructive',
      });
      return;
    }
    ...
    if (otp === '123456') {
      toast({
        title: t('Login Successful', 'लॉगिन सफल'),
        description: t('Welcome back to the Alumni Network!', 'पूर्व छात्र नेटवर्क में आपका स्वागत है!'),
      });
      ...
      toast({
        ...
        description: t('The OTP you entered is incorrect. Try 123456 for demo.', 'आपने जो OTP दर्ज किया है वह गलत है। डेमो के लिए 123456 आज़माएं।'),
        variant: 'destructive',
      });
    }
  };
            ...
            <CardContent className="space-y-6">
              ...
              <div className="text-center pt-4 border-t">
                <p className="text-sm text-muted-foreground">
                  ...
                  <Link to="/alumni/register" className="text-primary hover:underline">

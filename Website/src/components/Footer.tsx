      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/20">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-primary-foreground/70">
            <p>
              © {new Date().getFullYear()} {t('Seth Hirachand Gumanji Jain Trust. All rights reserved.', 'सेठ हीराचंद गुमानजी जैन ट्रस्ट। सर्वाधिकार सुरक्षित।')}
            </p>
            <div className="flex items-center gap-4">
              <Link to="/faq" className="hover:text-primary-foreground transition-colors">
                {t('FAQ', 'सामान्य प्रश्न')}
              </Link>
              <Link to="/facilities" className="hover:text-primary-foreground transition-colors">
